    ...
    <footer className="footer">
      <div className="footer__icons">
        ...
        >
          ...
          {/* svg = permite mostrar iconos que no pierden calidad
          fill = indica el color de relleno del icono (en este caso, blanco: #fff).
              d = es el atributo del elemento <path> que define la ruta vectorial del dibujo. */}
        </a>
      </div>
